...
public class AuthenticationManagerOld {

    private static AuthenticationManagerOld instance = new AuthenticationManagerOld();
    private User currentUser;

    private DatabaseConnectionHandler dbHandler = DatabaseConnectionHandler.getInstance();

    private AuthenticationManagerOld() {
        //dbHandler.connectToDatabase();
    }

    public static AuthenticationManagerOld getInstance() {
        return instance;
    }
